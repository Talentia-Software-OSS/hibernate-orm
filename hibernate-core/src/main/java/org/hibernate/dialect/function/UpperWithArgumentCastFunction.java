 ...
 */
public class UpperWithArgumentCastFunction extends StandardSQLFunction {
	private final TemplateRenderer renderer;

	public UpperWithArgumentCastFunction(String castType) {
		super("upper");
		renderer = new TemplateRenderer("upper(cast(?1 as " + castType + "))");
	}
